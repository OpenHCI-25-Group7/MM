...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["語氣是溫度，不同的說法會讓人冷或暖。", "有些傷人話，說出口前像開玩笑，說完後像落雨。", "也許我們都只是用錯的方式，說著其實想靠近的話。"],
			morning: ["今天空氣有點濕，感覺有人悶悶的", "情緒是昨日的霧，今天可以選擇看清楚。", "每個「早安」都是新的開始。"],
			afternoon: ["陽光下的對話，有時也會刺眼"],
			evening: ["晚安，希望今天的雷雨已經過去", "燈關了，對話還能亮著嗎？"],
			//"01-01": ["新年快樂！", "祝你新年快樂，萬事如意！"],
			//"02-14": ["情人節快樂！", "祝你情人節充滿愛與幸福！"]
		},
