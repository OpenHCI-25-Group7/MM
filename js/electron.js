...
function createWindow () {
	...
	if (config.kioskmode) {
		...
		electronOptionsDefaults.show = true;               // 改成 true，讓視窗可以顯示
		electronOptionsDefaults.frame = true;              // 有視窗框（比較好開發）
		electronOptionsDefaults.transparent = false;       // 不要透明背景
		electronOptionsDefaults.hasShadow = true;          // 加陰影比較好看
		electronOptionsDefaults.fullscreen = false;        // 關掉全螢幕
		electronOptionsDefaults.width = 1000;
		electronOptionsDefaults.height = 700;
	}
